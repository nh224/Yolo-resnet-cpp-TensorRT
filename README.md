...
https://github.com/nh224/Yolo-resnet-cpp-TensorRT/raw/main/asset/Yolo_v11_cpp_tenosrrt.PNG
📜 引用
...
安装
1. 克隆仓库：
2. git clone https://github.com/nh224/Yolo-resnet-cpp-TensorRT.git
cd YOLOv11-TensorRT
3. 更新 CMakeLists.txt 中的 TensorRT 和 OpenCV 路径：
4. set(TENSORRT_PATH "F:/Program Files/TensorRT-8.6.1.6")  # Adjust this to your path
原作者功能
主要特点：
- 模型转换：将 ONNX 模型转换为 TensorRT 引擎文件以加速推理。
- 视频推理：高效地对视频文件进行目标检测。
